...
SVC_NAME="actions.runner.vasumathi298-learn-continuous-integration.Vasumathis-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (vasumathi298-learn-continuous-integration.Vasumathis-MacBook-Air)"
